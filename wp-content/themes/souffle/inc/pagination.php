...
if (!function_exists('souffle_pagination')) {
    /**
     ...
     */
    function souffle_pagination($args = array(), $class = 'pagination')
    {
        ...
        $args = wp_parse_args(
            ...
            array(
                'mid_size'           => 2,
                'prev_next'          => true,
                'prev_text'          => __('&laquo;', 'souffle'),
                'next_text'          => __('&raquo;', 'souffle'),
                'type'               => 'array',
                'current'            => max(1, get_query_var('paged')),
                'screen_reader_text' => __('Posts navigation', 'souffle'),
            )
        );
